...
Patch0:     dante-%{version}-sendbuf_macro.patch
### https://gitweb.gentoo.org/repo/gentoo.git/tree/net-proxy/dante/files/dante-1.4.0-socksify.patch
Patch1:     dante-%{version}-socksify.patch

## 'librt.so' and 'libdl.so' from 'glibc-devel' package
Requires:       glibc-devel
BuildRequires:  autoconf automake bison flex glibc-devel libtool pam-devel
